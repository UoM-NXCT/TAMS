...
Custom toolbox class that inherits the Qt built-in QToolBox widget. Doing this
permits extra functionality and removes the amount of code from the main window
